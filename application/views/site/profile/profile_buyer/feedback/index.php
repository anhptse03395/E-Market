...
<div class="container">
    <div class="row">
    <form action="<?php echo user_url('profile/feedback_buyer') ?>" method="post">
        ...
        <div class="form_main col-md-4 col-sm-5 col-xs-7">
            ...
            <div class="form-group ">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control " style="text-align: center;" placeholder=" Tên Liên Lạc" name="p_name" value="<?php echo $info->buyer_name ?>"  /></div>
            </div>
