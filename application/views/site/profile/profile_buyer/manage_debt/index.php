...
<div class="col-md-9" id="customer-orders" style="width: 100%">
    <div class="box">
        ...
        <form action="<?php echo user_url('profile/manage_debt_buyer') ?>" method="post">
            <div class="form-group">

                    <button type="submit" class="btn btn-default">List order</button>
            </div>
        </form>
            ...
            <table class="table table-hover">
                ...
                <?php foreach ($list as $row):?>
                    <tr>
                        ...
                        <td><a href="<?php echo user_url('profile/list_debt_details/'.$row->order_id) ?>" class="btn btn-info btn-sm">xem</a>
