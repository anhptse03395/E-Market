...
<script type="text/javascript">
  $(function() {
    ...
    <div class="col-md-9" id="customer-orders" style="width: 100%">
     ...
     <!--    <div class="text-center" style="margin-bottom: 10%"> <?php echo '<h4 style="color:blue">'.'Tổng số tiền  đã thanh toán' .' '.number_format($total_info->sum_paid, 0, '.', ',').' '.'nghìn đồng'.'</h4>' ?></div> -->
      ...
      <div class="form-group" style="width: 80%" >
        <label class="col-xs-3 control-label">Tên cửa  hàng</label>
        <div class="input-group">
          <span class="input-group-addon"><span class="glyphicon glyphicon-list-alt"></span>
        </span>
...
<div class="form-group">
 ...
 <div class="text-center" style="margin-bottom: 5%;margin-left: -5%;margin-top: 5%"> <?php echo '<h4 style="color:blue">'. 'Tổng số tiền còn nợ' .' '.number_format($total_info->sum_debt, 0, '.', ',').' '.'nghìn đồng'.'</h4>'?></div>
