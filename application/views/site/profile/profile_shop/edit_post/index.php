                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea type="text" style="width: 100%" class="form-control" rows="9" cols="25" name="description"  placeholder="Nội Dung Đăng Bài" <?php echo $product->description?>></textarea>
