		...
		<form class="form" id="form" action="" method="post" enctype="multipart/form-data">
			<fieldset>
				...
				<div class="formRow">
					...
					<div class="formRight">
						<span class="oneTwo"><input style="border: 2px ridge" type="text" _autocheck="true" id="param_phone" value="<?php echo set_value('buyer_name')?>" name="buyer_name"></span>
				...
				<div class="formRow">
					...
					<div class="formRight">
						<span class="oneTwo"><input style="border: 2px ridge" type="text" readonly="true" _autocheck="true" id="param_phone" value="Người Mua" name="role_id"></span>
						<span class="autocheck" name="phone_autocheck"></span>
