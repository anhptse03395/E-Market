		...
		<form class="form" id="form" action="" method="post" enctype="multipart/form-data">
			<fieldset>
				...
				<div class="formRow">
					...
					<div class="formRight">
						<span class="oneTwo"><input type="text" _autocheck="true" id="param_phone" value="<?php echo set_value('shop_name')?>" name="shop_name"></span>
				...
				<div class="formRow">
					...
					<div class="formRight">
						<span class="oneTwo"><input type="text" readonly="true" _autocheck="true" id="param_phone" value="Người Bán" name="role_id"></span>
						<span class="autocheck" name="phone_autocheck"></span>
