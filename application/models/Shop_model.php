...
Class Shop_model extends MY_Model{
	...
	function  join_role(){
		...
		$this->db->select('accounts.id as account_id, role_name,shop_name,phone,address,market_name,active,created');
		$this->db->from('shops');
	...
	function join_edit_seller($account_id)
	{
		...
		$this->db->select('accounts.id as account_id,shop_name,phone,address,shops.id as shop_id,market_id');
		$this->db->from('shops');
